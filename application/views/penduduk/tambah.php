                            ...
                            <div class="card-body">
                                <form action="" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="id_nik" class="form-control" id="id_nik" placeholder="Masukan Nomor NIK" value="<?= set_value('id_nik'); ?>">
                                        <small class="form-text text-danger pl-3"><?= form_error('id_nik'); ?></small>
                                    </div>
                                    <div class="form-group">
                                        <label for="id_kk">Nomor KK :</label>
                                        <input type="text" name="id_kk" class="form-control" id="id_kk" placeholder="Masukan Nomor KK" value="<?= set_value('id_kk'); ?>">
                                        <small class="form-text text-danger pl-3"><?= form_error('id_kk'); ?></small>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <small class="form-text text-danger pl-3"><?= form_error('tempat_lahir'); ?></small>
                                    </div>
                                    <div class="form-group">
                                        <label for="tanggal_lahir">Tanggal Lahir :</label>
                                        <input type="date" name="tanggal_lahir" class="form-control" id="tanggal_lahir" value="<?= set_value('tanggal_lahir'); ?>">
                                        <small class="form-text text-danger pl-3"><?= form_error('tanggal_lahir'); ?></small>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <small class="form-text text-danger pl-3"><?= form_error('pekerjaan'); ?></small>
                                    </div>
                                    <div class="form-group">
                                        <label for="kewarganegaraan">Kewarganegaraan :</label>
                                        <select class="form-control" id="kewarganegaraan" name="kewarganegaraan" value="<?= set_value('pekerjaan'); ?>">
